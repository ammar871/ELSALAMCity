...
public class AdpterFullScreen extends RecyclerView.Adapter<AdpterFullScreen.ViewHolderVidio> {

    private ArrayList<String> list;
    private Context mcontext;


    public AdpterFullScreen(ArrayList<String> list, Context mcontext) {
